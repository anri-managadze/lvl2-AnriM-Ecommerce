...
import {useStyles} from "../SignIn-component/SignInStyle";
import SignInForm from "../SignIn-component/SignInForm";
        ...
        <MainLayout>
            ...
            <Box className={classes.cont}>
                ...
                <Box textAlign='center' marginTop='25px'>
                    <Box marginTop='25px'>Not a member? <Link to={SIGN_UP} className={classes.link}> Register</Link></Box>
