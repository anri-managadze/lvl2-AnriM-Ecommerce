...
const SideBar = () => {
  ...
  return (
    <>
      <Box>
        <Box fontSize="20px" fontWeight="bold" color="#4F4F4F">
          Subcategories
        </Box>
        <ListItemLink className={classes.gutters}>
      ...
      <Box>
        <Box fontSize="20px" marginTop="60px" fontWeight="bold" color="#4F4F4F">
          Filters
        </Box>
      ...
      <Box>
        <Box fontSize="16px" marginTop="60px" fontWeight="bold" color="#4F4F4F">
          Condition
        </Box>
        <Box marginTop="15px">
          <Checkbox label="NEW" value="new" />
        </Box>
        <Box>
          <Checkbox label="USED" value="used" />
        </Box>
        <Box>
          <Checkbox label="COLLECTIBLE" value="collectible" />
        </Box>
        <Box>
          <Checkbox label="RENEWED" value="renewed" />
        </Box>
      </Box>
      <Box>
        <Box fontSize="16px" marginTop="60px" fontWeight="bold" color="#4F4F4F">
      ...
      <Box>
        ...
        <Box marginTop="15px">
          <Checkbox label="34" value="34" />
        </Box>
        <Box>
          <Checkbox label="36" value="36" />
        </Box>
        <Box>
          <Checkbox label="38" value="38" />
        </Box>
        <Box>
          <Checkbox label="40" value="40" />
        </Box>
      </Box>
      <Box width="20%">
        <ListMenu
        ...
        >
          <Box marginTop="15px">
            <Checkbox label="42" value="42" />
          </Box>
          <Box>
            <Checkbox label="44" value="44" />
          </Box>
          <Box>
            <Checkbox label="46" value="46" />
          </Box>
          <Box>
            <Checkbox label="48" value="48" />
          </Box>
        </ListMenu>
      </Box>
      <Box fontSize="16px" marginTop="60px" fontWeight="bold" color="#4F4F4F">
