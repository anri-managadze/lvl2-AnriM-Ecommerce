            ...
            <Container >
                <Grid container component={Box} pt='30px' pb='30px' color='#eeeded'  >
                    ...
                    <Grid item xs={12} sm={3} >
                        ...
                        <Box width='60px' height='1px' bgcolor='#1266F1' mt='10px'> </Box>
                        <Box marginTop='35px' fontSize='14.5px' display='flex' ><MapIcon />New York, Avenue Street 10</Box>
                        <Box marginTop='18px' fontSize='14.5px' display='flex' ><PhoneIcon />042 876 836 908</Box>
                        <Box marginTop='18px' fontSize='14.5px' display='flex' flexWrap='wrap'><EmailIcon /> company@example.com</Box>
                        <Box marginTop='18px' fontSize='14.5px' display='flex' ><ScheduleIcon />Monday - Friday: 10-17</Box>
                    </Grid>
                </Grid>
            </Container>
        </Grid>
