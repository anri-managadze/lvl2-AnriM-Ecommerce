...
export default function HeaderAppBar() {
    ...
    return (
            <Container className={classes.header }>
                <AppBar position="static"  component={Box}  bgcolor='white' display='flex' flexDirection='row' justifyContent='space-between' padding='10px 50px 0 50px' className={classes.elevation4}>
